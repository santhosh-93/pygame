...
#music_path = '/home/murali/Desktop/projects/interns/smart_desk/pygame_music'
#swoosh=pg.mixer.Sound(music_path+'/whoosh.mp3')
#X_square details
...
while(True):
    ...
    #frame setting for smartdesk
    frame = frame1[45:360,10:625]

##    #frame copying for switch
##    play_frame = frame.copy()
...
##    #boundary rectangle
##    cv2.rectangle(out, (5,5), (1205,625), (255,0,0), 3)
##    
##    #switch rectangle
##    cv2.rectangle(out, (1050,540), (1190,605), (255,255,255), -1)
##    cv2.putText(out,'PLAY',(1080,580),font,1,(0,255,0),2)        
##
##    #sensing the switch area
##    play_frame_gray = cv2.cvtColor(play_frame, cv2.COLOR_BGR2GRAY)
##    ret, play_frame_thresh = cv2.threshold(play_frame_gray, 250, 255, cv2.THRESH_BINARY) 
##    play_switch_contour,_=cv2.findContours(play_frame_thresh,cv2.RETR_TREE,cv2.CHAIN_APPROX_SIMPLE)
##    for c in play_switch_contour:
##        play_area = cv2.contourArea(c)
##        print(play_area)
##        if play_area <100:
...
##            while ix < qx or iy < qy:
##                if ix < qx:
##                    pygame.draw.lines(screen, (255,255,0),False,[(px,py),(ix+5,py)], 5)
##                    ix +=5
##                if iy < qy:
##                    pygame.draw.lines(screen, (255,255,0),False,[(px,py),(px,iy+5)], 5)
##                    iy +=5;
##                pygame.display.update()
##                clock.tick(30)
##                
####            while py < qy:
####                pygame.draw.lines(screen, (255,255,0),False,[(px,py),(px,py+5)], 5)
####                py +=5
####                #print(px)
####                pygame.display.update()
####                clock.tick(30)
##
##            while py < qy:
##                pygame.draw.lines(screen, (255,255,0), False, [(qx,py),(qx,py+5)], 5)
##                py +=5
##                pygame.display.update()
##                clock.tick(30)
##            
##            while px < qx:
##                pygame.draw.lines(screen, (255,255,0), False, [(px,qy),(px+5,qy)], 5)
##                px +=5
##                pygame.display.update()
##                clock.tick(30)
            ...
            #pygame.draw.lines(screen, (255,255,0), False, left_points, 5)
